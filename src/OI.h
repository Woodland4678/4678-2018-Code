...
private:
	...
	std::shared_ptr<frc::JoystickButton> driverBtn9_Back_Climber;
	std::shared_ptr<frc::JoystickButton> driverBtn7_LTrigger_Unclamp;
	std::shared_ptr<frc::JoystickButton> driverBtn4_Y_CubeTransfer;
	std::shared_ptr<frc::JoystickButton> driverBtn10_Start_FindCube;
	std::shared_ptr<frc::JoystickButton> driverBtn12_RJoy_InTakeWheelsOut;
	std::shared_ptr<frc::JoystickButton> driverBtn1_X_StopWheels;
	...
	std::shared_ptr<frc::JoystickButton> driverBtn8_RTrigger_Clamp;
