...
void Robot::TeleopPeriodic() {
	...
	cnt++;
	//Robot Checks
	frc::SmartDashboard::PutNumber("Arm Current", manipulatorArm->currPos);
	frc::SmartDashboard::PutNumber("Arm Target", manipulatorArm->targetPos);
	frc::SmartDashboard::PutNumber("leftSpeed", Robot::driveTrain->getLeftSpeed());

	manipulatorArm->updateArm();
	intake->updateEndEffector();
	int scal = scaleDetection->FoundScale();
	if(scal == 1)
		frc::SmartDashboard::PutBoolean("Scale Front", true);
	else
		frc::SmartDashboard::PutBoolean("Scale Front", false);
	if(scal == 2)
		frc::SmartDashboard::PutBoolean("Scale Back", true);
	else
		frc::SmartDashboard::PutBoolean("Scale Back", false);
