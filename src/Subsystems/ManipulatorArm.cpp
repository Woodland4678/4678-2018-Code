...
ManipulatorArm::ManipulatorArm() : frc::Subsystem("ManipulatorArm") {
	...
	elbowSeg.convIntercept = -162.5 - getElbowAngular()*elbowSeg.convSlope ;
	elDegreePerSecond = 90;
	elMinTime = 2;
	updateElbow();
	
	if(std::abs(elbowSeg.absAngle - (-54.5)) < 15)
...
bool ManipulatorArm::fineMovement(double yDirection, double xDirection)
	{
