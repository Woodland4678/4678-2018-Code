...
#define	WRISTHIGENCODER		4553.0f //Update this one //4751
...
ManipulatorArm::ManipulatorArm() : frc::Subsystem("ManipulatorArm") {
	...
	do {
		...
		shAngCnt++;
	}while((std::abs(pulse - enc) > 100)&&(shAngCnt < 10));
		...
		case 2:
			...
			switch(wrCase)
				...
				case 0:
					...
					if((wrist->GetSensorCollection().GetQuadratureVelocity() > 0.2)||(count > 20))
						wrCase = 1;
					break;
				case 1:
					//Check speed
