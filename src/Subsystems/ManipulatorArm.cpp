...
ManipulatorArm::ManipulatorArm() : frc::Subsystem("ManipulatorArm") {
    ...
    positions[5][1] = -37;   //e:2478    r:-154
    positions[5][2] = -74;   //e:754     r:-28
...
bool ManipulatorArm::moveTo(int pos, double addShTime, double addElTime)
	...
	switch(moveCase)
		...
		case 4:
			pickupCount++;
			//Pickup special case
			//The arm at this point should be above the cube
			//Lets move straight down until we detect a cube in the claw
			//fineMovement(0,-(0.03*pickupCount));
			double ang = positions[5][0] - (pickupCount * 0.5);
