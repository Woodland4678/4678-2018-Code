...
private:
	...
	volatile int glob_lidar_ready; // Gets set to 1 when lidar data is ready in lidat[].  Processing routines should
	...
	tpPoint lidatXY[1024]; // Allow up to 1024 samples in the final array prepared for processing.
