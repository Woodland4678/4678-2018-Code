...
public:
	...
	unsigned int FilterRaw(rplidar_response_measurement_node_t *nodes, rplidar_response_measurement_node_t *filteredNodes, size_t count, double MinAngle, double MaxAngle, double MinDistance, double MaxDistance);
	void ConvertToXY(rplidar_response_measurement_node_t *nodes, tpPoint *out, unsigned int count);
