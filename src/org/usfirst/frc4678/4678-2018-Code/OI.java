...
import org.usfirst.frc4678.4678-2018-Code.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        driverBtn9 = new JoystickButton(driver, 9);
        driverBtn9.whenPressed(new raiseCube());
        driverBtn6 = new JoystickButton(driver, 6);
        driverBtn6.whenPressed(new RaiseIntake());
        driverBtn5 = new JoystickButton(driver, 5);
        driverBtn5.whenPressed(new LowerIntake());
        driverBtn2 = new JoystickButton(driver, 2);
        driverBtn2.whenPressed(new PickUpCube());
        driverBtn8 = new JoystickButton(driver, 10);
        ...
        SmartDashboard.putData("raiseCube", new raiseCube());
